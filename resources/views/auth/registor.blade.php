            ...
            <div class="offset-md-2 col-lg-5 col-md-7 offset-lg-4 offset-md-3">
                <div class="panel border bg-white">
                    <div class="panel-heading">
                        <h3 class="pt-3 font-weight-bold">Registor</h3>
                    </div>
                    <div class="panel-body p-3">
                        <form action="login_script.php" method="POST">
                            <div class="form-group py-2">
                                ...
                                <div class="form-group py-2">
                                    <div class="input-field"> <span class="far fa-user p-2"></span> <input type="email"
                                ...
                                <div class="form-inline"> <input type="checkbox" name="remember" id="remember"> <label
                                    ...
                                    <div class="btn btn-primary btn-block mt-3">Registor</div>
